...
$titles = array();
$macros = array();
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'active', 'active_row', '		<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'active', 'active_table', '<div id=\"crumb_nav\">
...
<div class=\"bar\">{\$pages}</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_board_closed', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_body', '<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_message_level_1', '<div id=\"messenger\">
	<h2><lang:messenger_title>:</h2>
	<p>{\$message}</p>
	<h4>(<a href=\"{\$link}\" title=\"<lang:messenger_forward>\"><lang:messenger_forward></a>)</h4>
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_welcome_admin', '<div class=\"welcome\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_welcome_disabled', '<div class=\"welcome\">
	<p class=\"links\"><lang:welcome_disabled></p>
        <p>&nbsp;</p>
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_welcome_guest', '<div class=\"welcome\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_welcome_member', '<div class=\"welcome\">
	<p class=\"links\"><lang:welcome_back>, <a href=\"<sys:gate>?getuser=<user:members_id>\" title=\"<lang:welcome_profile_title>\"><strong><user:members_name></strong></a>! (<a href=\"<sys:gate>?a=logon&CODE=02\" title=\"<lang:welcome_logout_title>\"><lang:welcome_logout></a>)</p>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_header', '{\$who} <lang:mailer_header> {\$sent}:
----------------------------------------------------------------

');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_footer', '
----------------------------------------------------------------
<lang:mailer_footer> MyTopix | Personal Message Board {\$this->config[\'version\']}.  http://www.jaia-interactive.com');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_wrapper', '			<div id=\"container\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'help', 'container_help', '<div id=\"crumb_nav\">
...
{\$entries}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'help', 'content_row', '<div class=\"infowrap\">
	<a name=\"{\$count}\"></a>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'help', 'title_row', '<li><a href=\"#{\$count}\" title=\"{\$row[\'help_title\']}\">{\$row[\'help_title\']}</a></li>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'logon', 'form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'logon', 'form_pass_retrieve_1', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_note_notify', 'Hello, {\$row[\'members_name\']}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_subscribe_topic_notice', 'Hello {\$row[\'members_name\']},
...
above link.');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'active_users', '<div class=\"infowrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'container_main', '<div id=\"crumb_nav\">
...
{\$active}
{\$board_stats}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'main_buttons', '<div class=\"postbutton\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'statistics', '<div class=\"infowrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_bit', '<div id=\"qwikform\" style=\"display: none;\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_table', '{\$buttons}
<div class=\"bar\">
	<span>
...
{\$buttons}
{\$post}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'members', 'list_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'members', 'list_table', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'misc', 'emoticon_row', '	<tr>
		<td class=\'celltwo\'>{\$code[\$i]}</td>
		<td class=\'celltwo\'>
			<a href=\'javascript:add_smilie(\"{\$code[\$i]}\")\'>{\$name[\$i]}</a>
		</td>
	</tr>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'misc', 'emoticon_wrapper', '<script language=\'javascript\'>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mod', 'topic_editor', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'notes', 'notes_reply_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'notes', 'notes_send_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'notes', 'note_none', '							<tr>
								<td class=\"cellone\" align=\"center\" colspan=\"5\"><strong><lang:no_notes></strong></td>
							</tr>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'notes', 'note_read', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'notes', 'note_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'notes', 'note_table', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'bbcode_field', '	<div id=\'bbcode_panel\' style=\'display: none;\'>
		<h3><lang:bb_title></h3>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'emoticons_field', '		<h3><lang:post_emoticon_title></h3>
		<h4><lang:post_emoticon_tip></h4>
		{\$smilies}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_wrapper', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'quote_field', '		<h3><lang:post_field_quote></h3>
		<h4><lang:post_field_quote_tip></h4>
		<textarea name=\"quote\">{\$message}</textarea>
		{\$hidden}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'smilie_wrapper', '<table class=\"emoticon\" cellpadding=\"0\" cellspacing=\"0\">
	{\$smilies}
</table>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_field_title', '		<h3><lang:post_field_title></h3>
		<h4><lang:post_field_title_tip></h4>
		<input type=\"text\" name=\"title\" tabindex=\"1\" value=\"{\$title}\" />');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'profile', 'profile_table', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'container_read', '<div id=\"crumb_nav\">
...
{\$replier}
{\$readers}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'post_row', '<div class=\"user\">
...
<div class=\"postend\">&nbsp;</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'post_row_guest', '<div class=\"user\">
	<a name=\"{\$row[\'posts_id\']}\"></a>
...
<div class=\"postend\">&nbsp;</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'post_table', '{\$poll_data}
<div class=\"postwrap\">
        <div class=\"postheader\">{\$topic[\'topics_title\']}</div>
        {\$list}
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_active', '<div class=\"infowrap\">
	<h1><lang:readers_title></h1>
	<h2><lang:readers_user_summary> ( <a href=\"<sys:gate>?a=active\" title=\"\"><lang:active_link_details></a> )</h2>
	<p>{\$list}</p>
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_buttons', '<div class=\"postbutton\">
	<p class=\"links\">&nbsp;</p>
	{\$button_reply} {\$button_qwik} {\$button_topic} {\$button_poll}
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'reply_bit', '<div id=\"qwikwrap\" style=\"display: none;\">
	<script language=\"javascript\">
	function check_length()
	{
		var limit  = <conf:max_post> * 1000;
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_general', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'sig', '<p class=\"sig\">{\$row[\'members_sig\']}</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'register', 'form_register', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_validate_user', 'Hello, {\$username}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'by_user_row', '<div id=\"resultwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'by_user_table', '<div id=\"crumb_nav\">
<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <strong>{\$count}</strong> <lang:search_result_user_title> <strong>{\$user}</strong>:
</div>
<div class=\"bar\">{\$pages}</div>
{\$list}
<div class=\"bar\">{\$pages}</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'search_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mod', 'move_topic', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_jump_list', '	<span>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'search_full_result_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'search_full_result_table', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_sig', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
{\$error_list}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_pass', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
{\$error_list}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'page_wrapper', '<macro:img_mini_pages> {\$links}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'email', 'email_member_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'print', 'print_body', '<script language=\"JavaScript\">
	<!--
	window.print();
	-->
</script>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'print', 'print_row', '<h4><a href=\'<sys:gate>?getuser={\$row[\'members_id\']}\'><strong>{\$row[\'members_name\']}</strong></a> | <span>{\$row[\'posts_date\']}</span></h4>
<div class=\"post\">{\$row[\'posts_body\']}</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'mod_option_lock', '		<p class=\"checkwrap\"><input type=\"checkbox\" class=\"check\" name=\"lock\" value=\"1\" {\$check[\'locked\']} /> <strong><lang:post_mod_options_lock></strong></p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'post_name_field', '		<h3><lang:post_field_name></h3>
		<h4><lang:post_field_name_tip></h4>
		<input type\"text\" name=\"name\" tabindex=\"1\" value=\"{\$name}\" />');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_banned', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a>
</div>
<form method=\"post\" action=\"<sys:gate>?a=logon&amp;CODE=01\">
	<div class=\"formwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_options', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_email', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
{\$error_list}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_pass_get_2', 'Hello, {\$row[\'members_name\']}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_pass_get_1', 'You have recently attempted to recover your password from <conf:title> ( <conf:site_link> ).
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_admin_user', 'Hello, {\$name}
...
Log INTO my_your account through the link below:
<conf:site_link><sys:gate>?a=logon\";');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_tabs', '<ul id=\"ucp_tabs\">
	{\$list}
</ul>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'search_match_result_row', '<tr>
	<td class=\"cellthree\" align=\"center\" valign=\"top\"><a href=\"<sys:gate>?gettopic={\$row[\'topics_id\']}&amp;view=lastpost\" title=\"<lang:link_post_jump>\">{\$row[\'topics_marker\']}</a></td>
	<td class=\"cellone\">{\$row[\'topics_prefix\']} <a href=\"<sys:gate>?gettopic={\$row[\'topics_id\']}&amp;hl={\$hlLink}\" title=\"\">{\$row[\'topics_title\']}</a> {\$inlineNav}<span class=\"special\">-- {\$row[\'topics_subject\']}</span></td>
	<td class=\"celltwo\" align=\"center\"><strong>{\$row[\'topics_posts\']}</strong></td>
	<td class=\"cellone\" align=\"center\">{\$row[\'topics_views\']}</td>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'search', 'search_match_result_table', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <a href=\"<sys:gate>?a=search\" title=\"<lang:search_form_title>\"><lang:search_form_title></a> / <strong>{\$count}</strong> <lang:search_result_title>:
</div>
<div class=\"bar\">{\$pages}</div>
<div class=\"maintable\">
...
<div class=\"bar\">{\$pages}</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'register', 'resend_validation_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_registration_complete', 'Hello, {\$username}
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_main', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
<div class=\"formwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_sub_none', '<tr>
	<td colspan=\"4\" align=\"center\"><strong><lang:main_sub_none></strong></td>
</tr>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_sub_topic_row', '		<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_container', '<div id=\"crumb_nav\">
...
{\$active_users}
{\$board_stats}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_cat_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_cat_redirect', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_cat_wrapper', '<div class=\"maintable\">
	<table cellpadding=\"0\" cellspacing=\"1\" width=\"100%\">
		<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_last_post', '<span><macro:img_mini_box> {\$last_date}</span>
<lang:last_post_in> {\$forum[\'forum_last_post_title\']}
<br /><lang:last_post_by> <strong>{\$forum[\'forum_last_post_user_name\']}</strong>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_news_section', '<div id=\"community_news\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_none', '							<tr>
								<td class=\"cellone\" align=\"center\" colspan=\"6\"><strong><lang:no_topics></strong></td>
							</tr>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_cat_row', '<tr>
	<td class=\"cellthree\" align=\"center\" valign=\"top\"><a href=\"<sys:gate>?getforum={\$forum[\'forum_id\']}\" title=\"\">{\$marker}</a></td>
	<td class=\"cellone\"><h4><a href=\"<sys:gate>?getforum={\$forum[\'forum_id\']}\" title=\"\">{\$forum[\'forum_name\']}</a></h4><p>{\$forum[\'forum_description\']}{\$mods}{\$subs}</p></td>
	<td class=\"celltwo\" align=\"center\"><strong>{\$forum[\'forum_topics\']}</strong></td>
	<td class=\"celltwo\" align=\"center\">{\$forum[\'forum_posts\']}</td>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_cat_redirect', '<tr>
	<td class=\"cellthree\" align=\"center\" valign=\"top\"><macro:cat_redirect></td>
	<td class=\"cellone\"><h4><a href=\"<sys:gate>?getforum={\$forum[\'forum_id\']}\" title=\"\">{\$forum[\'forum_name\']}</a></h4><p>{\$forum[\'forum_description\']}</p></td>
	<td class=\"redirect\" nowrap=\"nowrap\" align=\"center\" colspan=\"3\">{\$forum[\'forum_red_clicks\']} <lang:cat_redirect></td>
</tr>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_cat_wrapper', '<div class=\"maintable\">
	<table cellpadding=\"0\" cellspacing=\"1\" width=\"100%\">
		<tr>
			<td class=\"header\" colspan=\"5\"><a href=\"<sys:gate>?getforum={\$category[\'forum_id\']}\">{\$category[\'forum_name\']}</a></td>
		</tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_last_post', '<span><macro:img_mini_box> {\$last_date}</span>
<lang:last_post_in> {\$forum[\'forum_last_post_title\']}
<br /><lang:last_post_by> <strong>{\$forum[\'forum_last_post_user_name\']}</strong>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'mod_option_wrapper', '		<h3><lang:post_options></h3>
		<h4><lang:post_options_tip></h4>
		{\$lock}
		{\$pin}
		{\$hide}
		{\$announce}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'mod_option_pin', '		<p class=\"checkwrap\"><input type=\"checkbox\" class=\"check\" name=\"stick\" value=\"1\" {\$check[\'stuck\']} /> <strong><lang:post_mod_options_pin></strong></p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_option_bar', '		<h3><lang:post_options></h3>
		<h4><lang:post_options_tip>.</h4>
		...
		{\$poll}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'topic_prefix', '<a href=\"<sys:gate>?gettopic={\$row[\'topics_id\']}&amp;view=lastpost\" title=\"<lang:link_post_jump>\"><macro:img_prefix></a>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_button', '<a href=\"<sys:gate>{\$url}\" title=\"{\$title}\"><img src=\"<sys:skinPath>/{\$button}.gif\" alt=\"\" /></a>&nbsp;');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_field_subject', '		<h3><lang:post_field_subject></h3>
		<h4><lang:post_field_subject_tip></h4>
		<input type=\"text\" name=\"subject\" tabindex=\"1\" value=\"{\$subject}\" />');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_jump_list', '<div class=\"bar\">
	<form method=\"post\" action=\"<sys:gate>?a=topics\">
		<select name=\"forum\" class=\"jump\">
			{\$jump_list}
		</select><input type=\"image\" src=\"<sys:skinPath>/btn_go.gif\" class=\"small_button\" value=\"<lang:forum_jump>\" />
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_mod_list', '<div class=\"bar\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topics_active', '<div class=\"infowrap\">
	<h1><lang:viewers_title></h1>
	<h2><lang:viewers_user_summary> ( <a href=\"<sys:gate>?a=active\" title=\"\"><lang:active_link_details></a> )</h2>
	<p>{\$list}</p>
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_mod_wrapper', '<p class=\"mod_list\"><strong><lang:mod_label></strong> {\$mod_list}</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_sub_wrapper', '<p class=\"mod_list\"><strong><lang:sub_label></strong> {\$sub_list}</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_mod_wrapper', '<p class=\"mod_list\"><strong><lang:mod_label></strong> {\$mod_list}</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_sub_wrapper', '<p class=\"mod_list\"><strong><lang:sub_label></strong> {\$sub_list}</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_subscribe_forum_notice', 'Hello {\$row[\'members_name\']},
...
off within your personal control panel. To do this you may access your UCP through the 
above link.');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_subs', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
<div class=\"formwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_sub_forum_row', '		<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'topics', 'topic_stats', '<div class=\"infowrap\">
	<h1><lang:stat_title>:</h1>
	<h2><lang:stat_tip></h2>
	<p><lang:stat_totals><br />
	<lang:stat_newest><br />
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'mod_option_announce', '		<p class=\"checkwrap\"><input type=\"checkbox\" class=\"check\" name=\"announce\" value=\"1\" {\$check[\'announce\']} /> <strong><lang:post_mod_options_announce></strong></p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_avatar_form', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
<div class=\"formwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_avatar_gallery_form', '<div id=\"crumb_nav\">
	<a href=\"<conf:site_link>\" title=\"\"><conf:title></a> / <lang:ucp_crumb_title>
</div>
{\$ucp_tabs}
<div class=\"formwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_avatar_row', '<td align=\"center\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_month_wrapper', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_blank_row', '<td class=\"{\$class}\">&nbsp;</td>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_date_row', '<td class=\"{\$class}\"><h4>{\$day}</h4><div class=\"events\">{\$events}</div></td>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_new_event_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_month_event', '<p>{\$event}</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_read_event', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_group_list', '		<h3><lang:form_groups_title></h3>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'calendar', 'cal_edit_event_form', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_attach_poll', '<div id=\"crumb_nav\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_option_poll', '		<p class=\"checkwrap\"><input type=\"checkbox\" class=\"check\" name=\"poll\" value=\"1\" {\$poll_check} /> <lang:post_options_poll></p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_choice_wrapper', '<form method=\"post\" action=\"<sys:gate>?a=read&amp;CODE=05&amp;t={\$this->_id}\">
	<div class=\"maintable\">
		<table cellpadding=\"0\" cellspacing=\"1\" width=\"100%\">
			<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_poll_choice_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_poll_result_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_result_wrapper', '<div class=\"maintable\">
	<table cellpadding=\"0\" cellspacing=\"1\" width=\"100%\">
		<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mod', 'mod_poll_wrapper', '		<h3><lang:mod_poll_editor_title></h3>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mod', 'mod_poll_option_row', '		<input type=\"text\" name=\"choice[{\$val[\'id\']}]\" style=\"width: 60%;\" tabindex=\"2\" value=\"{\$val[\'choice\']}\" /><input type=\"text\" name=\"votes[{\$val[\'id\']}]\" size=\"5\" style=\"width: auto;\" tabindex=\"2\" value=\"{\$val[\'votes\']}\" /><br />');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'attach_rem_field', '<p class=\"checkwarn\"><input type=\"checkbox\" class=\"check\" name=\"remove_attach\" value=\"1\"  />&nbsp;<lang:attach_rem>&nbsp;( <a href=\"<sys:gate>?a=misc&amp;CODE=01&amp;id={\$file_id}\">{\$file_name}</a> )</p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'main', 'main_new_note', '<div id=\"message_alert\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'form_error_wrapper', '<div id=\"warning\">
<h3><lang:err_wrap_title></h3>
<p><strong><lang:err_wrap_desc></strong></p>
<ul>{\$err_list}</ul>
</div>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_files_none', '<tr>
	<td colspan=\"7\" align=\"center\"><strong><lang:file_none></strong></td>
</tr>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'ucp', 'ucp_files_row', '<tr>
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'read', 'read_attach', '<p class=\"attach\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_coppa', 'In compliance with the COPPA act your account is currently inactive.
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_message_level_2', '<div id=\"crumb_nav\">
...
{\$logon_form}');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'global', 'global_message_level_2_logon', '<form method=\"post\" action=\"<sys:gate>?a=logon&amp;CODE=01\">
	<div class=\"formwrap\">
...
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'register', 'form_coppa_field', '		<p class=\"checkwarn\"><input class=\"check\" type=\"checkbox\" name=\"coppa\" {\$coppa} /> <strong><lang:field_coppa_agree></strong></p>');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'mailer', 'mail_admin_user_name', 'Hello, {\$member[\'members_name\']}
...
<conf:site_link><sys:gate>?a=logon');";
$temps[] = "INSERT INTO "my_"templates VALUES ({$dir}, 'post', 'form_field_attach', '		<h3><lang:attach_title></h3>
		<h4>{\$size_lang}</h4>
		<p class=\"checkwrap\"><input type=\"file\" name=\"upload\" /></p>');";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'wtf.gif', ':wtf:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'wink.gif', ';)', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'huh.gif', ':huh:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'up.gif', ':up:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'tongue.gif', ':P', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'stare.gif', ':|', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'squint.gif', '>_<', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'smile.gif', ':)', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'sick.gif', ':sick:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'shock.gif', ':o', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'shame.gif', ':shame:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'scared.gif', ':scared:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'sad.gif', ':(', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'rolleyes.gif', ':rolleyes:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'right.gif', ':right:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'rage.gif', ':rage:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'point.gif', ':point:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'nerd.gif', ':nerd:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'lup.gif', ':lup:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'left.gif', ':left:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'ldown.gif', ':ldown:', 0);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'laugh.gif', ':laugh:', 0);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'joy.gif', ':joy:', 0);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'angry.gif', ':angry:', 0);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'happy.gif', ':happy:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'grin.gif', ':D', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'glare.gif', ':glare:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'evil.gif', ':evil:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'down.gif', ':down:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'dead.gif', ':dead:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'crazy.gif', ':crazy:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'cool.gif', ':cool:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'booyah.gif', ':booyah:', 1);";
$emots[] = "INSERT INTO "my_"emoticons VALUES (null, {$dir}, 'blank.gif', ':blank:', 1);";
$titles[] = "INSERT INTO "my_"titles VALUES (null, 'Newcomer', 0, 1, 'pip_blue.gif', {$dir});";
$titles[] = "INSERT INTO "my_"titles VALUES (null, 'Common Folk', 25, 3, 'pip_poop.gif', {$dir});";
$titles[] = "INSERT INTO "my_"titles VALUES (null, 'MyTopix™ Enthusiast', 100, 4, 'pip_purple.gif', {$dir});";
$titles[] = "INSERT INTO "my_"titles VALUES (null, 'Needs a Life', 500, 6, 'pip_red.gif', {$dir});";
$titles[] = "INSERT INTO "my_"titles VALUES (null, 'Post Meister', 1000, 8, 'pip_green.gif', {$dir});";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_go', '<img src=\"{%SKIN%}/btn_go.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_aim', '<img src=\"{%SKIN%}/btn_aim.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_homepage', '<img src=\"{%SKIN%}/btn_homepage.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_icq', '<img src=\"{%SKIN%}/btn_icq.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_msn', '<img src=\"{%SKIN%}/btn_msn.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_note', '<img src=\"{%SKIN%}/btn_note.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_profile', '<img src=\"{%SKIN%}/btn_profile.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_yim', '<img src=\"{%SKIN%}/btn_yim.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'cat_archived', '<img src=\"{%SKIN%}/cat_archived.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'cat_new', '<img src=\"{%SKIN%}/cat_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'cat_old', '<img src=\"{%SKIN%}/cat_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'cat_redirect', '<img src=\"{%SKIN%}/cat_red.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'cat_subs_new', '<img src=\"{%SKIN%}/cat_subs_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'cat_subs_old', '<img src=\"{%SKIN%}/cat_subs_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_delete_note', '<img src=\"{%SKIN%}/delete_note.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_main_locked', '<img src=\"{%SKIN%}/main_locked.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_main_new', '<img src=\"{%SKIN%}/main_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_main_qreply', '<img src=\"{%SKIN%}/main_qreply.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_main_qtopic', '<img src=\"{%SKIN%}/main_qtopic.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_main_reply', '<img src=\"{%SKIN%}/main_reply.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_mini_box', '<img src=\"{%SKIN%}/mini_box.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_note_read', '<img src=\"{%SKIN%}/note_read.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_note_unread', '<img src=\"{%SKIN%}/note_unread.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_mini_pages', '<img src=\"{%SKIN%}/pages.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_post_delete', '<img src=\"{%SKIN%}/post_delete.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_post_edit', '<img src=\"{%SKIN%}/post_edit.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_post_quote', '<img src=\"{%SKIN%}/post_quote.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_hot_new', '<img src=\"{%SKIN%}/post_hot_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_hot_new_dot', '<img src=\"{%SKIN%}/post_hot_new_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_hot_old', '<img src=\"{%SKIN%}/post_hot_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_hot_old_dot', '<img src=\"{%SKIN%}/post_hot_old_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_locked_new', '<img src=\"{%SKIN%}/post_locked_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_locked_new_dot', '<img src=\"{%SKIN%}/post_locked_new_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_locked_old_dot', '<img src=\"{%SKIN%}/post_locked_old_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_locked_old', '<img src=\"{%SKIN%}/post_locked_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_moved', '<img src=\"{%SKIN%}/post_moved.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_open_new', '<img src=\"{%SKIN%}/post_open_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_open_old', '<img src=\"{%SKIN%}/post_open_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_open_old_dot', '<img src=\"{%SKIN%}/post_open_old_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_open_new_dot', '<img src=\"{%SKIN%}/post_open_new_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_offline', '<img src=\"{%SKIN%}/btn_offline.gif\" alt=\"\" title=\"\" />&nbsp;', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_pin_new', '<img src=\"{%SKIN%}/post_pinned_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_pin_old', '<img src=\"{%SKIN%}/post_pinned_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_online', '<img src=\"{%SKIN%}/btn_online.gif\" alt=\"\" title=\"\" />&nbsp;', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_private_new', '<img src=\"{%SKIN%}/post_private_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_private_new_dot', '<img src=\"{%SKIN%}/post_private_new_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_private_old_dot', '<img src=\"{%SKIN%}/post_private_old_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_private_old', '<img src=\"{%SKIN%}/post_private_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_note_reply', '<img src=\"{%SKIN%}/reply_note.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_prefix', '<img src=\"{%SKIN%}/topic_prefix.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_go', '<input type=\"image\" src=\"{%SKIN%}/btn_go.gif\" width=\"23px\" height=\"23px\" class=\"small_button\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_mini_email', '<img src=\"{%SKIN%}/btn_email.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'txt_bread_sep', '/', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'txt_online_sep', ',&nbsp;', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_announce_new', '<img src=\"{%SKIN%}/post_announce_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_announce_old', '<img src=\"{%SKIN%}/post_announce_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_poll_new', '<img src=\"{%SKIN%}/post_poll_new.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_poll_new_dot', '<img src=\"{%SKIN%}/post_poll_new_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_poll_old_dot', '<img src=\"{%SKIN%}/post_poll_old_dot.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'icon_poll_old', '<img src=\"{%SKIN%}/post_poll_old.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_note_send', '<img src=\"{%SKIN%}/send_note.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_add_event', '<img src=\"{%SKIN%}/main_event.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'btn_main_poll', '<img src=\"{%SKIN%}/main_poll.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'img_clip', '&nbsp;<img src=\"{%SKIN%}/topic_attach_prefix.gif\" alt=\"\" title=\"\" />', 0);";
$emots[] = "INSERT INTO "my_"macros VALUES (null, {$dir}, 'testte', 'test', 1);";
?>