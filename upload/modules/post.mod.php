...
class ModuleObject extends MasterObject
{
    ...
    function _buildPostBit($type)
	{
		...
		switch($type)
		{
			...
			case 'topic':
                ...
                $topic['topics_hidden']    = isset($this->post['hide'])     ? true : false;
			...
			case 'post':
                ...
                if($topic['topics_hidden'] && false == $this->UserHandler->getField('class_canPostHidden'))
                {
                    return $this->messenger(array('MSG' => 'err_hidden'));
                }
                ...
                $topic['topics_hidden']    = isset($this->post['hide'])     ? true : $topic['topics_hidden'];
    ...
    */
    function _doTopic()
	{
        ...
        if($eOption && false == $this->ParseHandler->countSmilies($body))
        {
...
echo $id . 'asdf';
        ...
        UPDATE " . DB_PREFIX . "forums SET
            ...
            forum_last_post_title     = '" . ucwords(strtolower($title)) . "'
        WHERE
        ...
        $this->_alertForumSubscribers($this->_forum, $id, ucwords(strtolower($title)));
    ...
    */
    function _doPost()
	{
        ...
        if($row['topics_hidden'] &&
           false == $this->UserHandler->getField('class_canPostHidden'))
        {
            return $this->messenger(array('MSG' => 'err_hidden'));
        }
        ...
        if($eOption &&
           false == $this->ParseHandler->countSmilies($body))
        {
            $this->_errors[] = $this->LanguageHandler->err_max_smilies;
        }
        ...
        if(false == $this->_is_qwik)
        {
            ...
            $row['topics_hidden']   = isset($hide)     ? (int) $hide     : 0;
		...
		UPDATE " . DB_PREFIX . "topics SET
            ...
            topics_hidden           = {$row['topics_hidden']},
    ...
    */
    function _doEditPost()
	{
        ...
        $topic['topics_hidden']   = isset($hide)     ? (int) $hide     : 0;
        ...
        UPDATE " . DB_PREFIX . "topics SET
            ...
            topics_hidden   = {$topic['topics_hidden']},
    ...
    */
    function _doAttachPoll()
    {
        ...
        foreach($choices_split as $val)
        {
            ...
            if(trim($val))
            {
                $choice_array[] = array('id' => $order, 'choice' => $val, 'votes' => 0);
            }
        }
