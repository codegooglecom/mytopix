...
class MyForm
{
	...
	*
	* @param String $tagForm field to wrap.
	...
	*/
	function addWrapSelect ( $name, $list, $offset = null, $extra = '', $wrap = null, $return = false, $add = '', $label = '' )
	{
		...
		if ( isset ( $wrap[ '0' ] ) )
		{
			$out = $this->addWrap ( $out, $wrap[ '1' ], $wrap[ '2' ], false );
		}
   ...
   // ! Action Method
	...
	/**
	* Completes the form with adding submit buttons.
	*
   ...
   // ! Action Method
	...
	/**
	* Adds more content to the end of the current buffer.
	*
