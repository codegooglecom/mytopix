	...
	function execute()
	{
        ...
        switch($this->_code)
		{
			...
			case '01':
                ...
                if(false == $this->MyPanel->canAccess('admin_mod_add'))
                {
			...
			case '05':
                ...
                if(false == $this->MyPanel->canAccess('admin_mod_edit'))
                {
                    $this->MyPanel->warning($this->LanguageHandler->role_no_perm, false);
                }
                else {
			...
			case '07':
                ...
                if(false == $this->MyPanel->canAccess('admin_mod_remove'))
                {
                    $this->MyPanel->warning($this->LanguageHandler->role_no_perm, false);
                }
                else {
	...
	function _showModerators()
	{
		...
		$this->MyPanel->appendBuffer("<form method=\"post\" action=\"" . GATEWAY . "?a=moderators&amp;code=01\">");
            ...
            for($i = 0; $i < sizeof($forums); $i++)
            {
                ...
                $this->MyPanel->table->addRow(array(array($this->MyPanel->form->addCheckBox('forums[]', $forums[$i]['forum_id'], false, false, true, false, false, false, 'checkwrap_4'), " valign=\"top\""),
                                                     array($forums[$i]['forum_name'], " valign=\"top\""),
                                                     array($mods)));
    ...
    function _showAddForm()
    {
		...
		$this->MyPanel->appendBuffer("<form method=\"post\" action=\"" . GATEWAY . '?a=moderators&amp;code=04">');
			...
			$this->MyPanel->table->startTable(sprintf($this->LanguageHandler->mod_add_table_header, $data['name'])); 
				...
				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_merge_posts),
										       array($this->MyPanel->form->addYesNo('merge_posts', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_merge_topics),
										       array($this->MyPanel->form->addYesNo('merge_topics', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_split),
										       array($this->MyPanel->form->addYesNo('split_topics', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_prune),
										       array($this->MyPanel->form->addYesNo('prune_topics', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_approve_posts),
										       array($this->MyPanel->form->addYesNo('approve_posts', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_unapprove_posts),
										       array($this->MyPanel->form->addYesNo('unapprove_posts', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_approve_topics),
										       array($this->MyPanel->form->addYesNo('approve_topics', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_unapprove_topics),
										       array($this->MyPanel->form->addYesNo('unapprove_topics', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_auto),
										       array($this->MyPanel->form->addYesNo('mod_auto', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_profile),
										       array($this->MyPanel->form->addYesNo('mod_edit_profile', 1, false, false, true))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_resynch),
										       array($this->MyPanel->form->addYesNo('mod_resynch', 1, false, false, true))));
    ...
    function _doModAdd()
    {
        ...
        foreach($forums as $forum)
        {
            ...
            VALUES (
                ...
                " . (int) $unapprove_posts  . ",
                " . (int) $approve_topics   . ",
                " . (int) $unapprove_topics . ",
                " . (int) $mod_auto         . ",
                " . (int) $mod_edit_profile . ",
				" . (int) $mod_resynch      . ")");
        }
    ...
    function _showModEditForm()
    {
		...
		$this->MyPanel->appendBuffer("<form method=\"post\" action=\"" . GATEWAY . "?a=moderators&amp;code=06&amp;id={$this->_id}\">");
			...
			$this->MyPanel->table->startTable(sprintf($this->LanguageHandler->mod_add_table_header, $mod['mod_user_name'])); 
				...
				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_merge_posts),
										       array($this->MyPanel->form->addYesNo('merge_posts', 1, false, false, true, $mod['mod_merge_posts']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_merge_topics),
										       array($this->MyPanel->form->addYesNo('merge_topics', 1, false, false, true, $mod['mod_merge_topics']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_split),
										       array($this->MyPanel->form->addYesNo('split_topics', 1, false, false, true, $mod['mod_split']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_prune),
										       array($this->MyPanel->form->addYesNo('prune_topics', 1, false, false, true, $mod['mod_prune']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_approve_posts),
										       array($this->MyPanel->form->addYesNo('approve_posts', 1, false, false, true, $mod['mod_approve_posts']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_unapprove_posts),
										       array($this->MyPanel->form->addYesNo('unapprove_posts', 1, false, false, true, $mod['mod_unapprove_posts']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_approve_topics),
										       array($this->MyPanel->form->addYesNo('approve_topics', 1, false, false, true, $mod['mod_approve_topics']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_unapprove_topics),
										       array($this->MyPanel->form->addYesNo('unapprove_topics', 1, false, false, true, $mod['mod_unapprove_topics']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_auto),
										       array($this->MyPanel->form->addYesNo('mod_auto', 1, false, false, true, $mod['mod_auto']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_profile),
										       array($this->MyPanel->form->addYesNo('mod_edit_profile', 1, false, false, true, $mod['mod_profiles']))));

				$this->MyPanel->table->addRow(array(array($this->LanguageHandler->mod_perm_resynch),
										       array($this->MyPanel->form->addYesNo('mod_resynch', 1, false, false, true, $mod['mod_resynch']))));
    ...
    */
    function _doModEdit()
    {
        ...
        UPDATE " . DB_PREFIX . "moderators SET
            ...
            mod_merge_posts         = " . (int) $merge_posts      . ",
            mod_merge_topics        = " . (int) $merge_topics     . ",
            mod_split               = " . (int) $split_topics     . ",
            mod_prune               = " . (int) $prune_topics     . ",
            mod_approve_posts       = " . (int) $approve_posts    . ",
            mod_unapprove_posts     = " . (int) $unapprove_posts  . ",
            mod_approve_topics      = " . (int) $approve_topics   . ",
            mod_unapprove_topics    = " . (int) $unapprove_topics . ",
            mod_auto                = " . (int) $mod_auto         . ",
            mod_profiles            = " . (int) $mod_edit_profile . ",
            mod_resynch             = " . (int) $mod_resynch      . "
        WHERE mod_id = {$this->_id}");       
